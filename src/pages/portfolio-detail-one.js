            ...
            <div className="container relative">
                <div className="grid grid-cols-1 pb-8 text-center mt-10">
                    ...
                    <ul className="list-none">
                        ...
                        <li className="inline font-semibold text-white/60"> <span className="text-white">Date :</span> 19th June, 2023</li>
                    </ul>
                </div>
            </div>
                ...
                <div className="grid md:grid-cols-12 grid-cols-1 gap-6">
                    <div className="lg:col-span-5 md:col-span-6">
                        <div className="grid grid-cols-1 gap-6">
                            <img src={portfolio1} className="rounded-xl" alt=""/>
                            <img src={portfolio2} className="rounded-xl" alt=""/>
                            <img src={portfolio3} className="rounded-xl" alt=""/>
                        </div>
                    </div>
